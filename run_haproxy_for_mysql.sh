...
### Haproxy setup ####
ansible-playbook -v -i $SCRIPT_PATH/hosts -e "{mysql_port: '$VAR_PORT', mysql_primary_server: '$VAR_PRIMARY_SERVER', mysql_backup_servers: '$VAR_BACKUP_SERVERS'}" $SCRIPT_PATH/playbook/haproxy_for_mysql.yml -l $VAR_HOST
